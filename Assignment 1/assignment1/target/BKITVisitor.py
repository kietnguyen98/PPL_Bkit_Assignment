...
class BKITVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BKITParser#main_funcDecl.
    def visitMain_funcDecl(self, ctx:BKITParser.Main_funcDeclContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BKITParser#non_main_funcDecl.
    def visitNon_main_funcDecl(self, ctx:BKITParser.Non_main_funcDeclContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by BKITParser#primitivetype.
    def visitPrimitivetype(self, ctx:BKITParser.PrimitivetypeContext):
        return self.visitChildren(ctx)
